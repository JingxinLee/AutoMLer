...
train_data = TabularDataset(
    "/root/paper/mypaper_code/automl/tasks/brazilian_houses/brazilianhouses_train.csv"
)
...
test_data = TabularDataset(
    "/root/paper/mypaper_code/automl/tasks/brazilian_houses/brazilianhouses_test.csv"
)
