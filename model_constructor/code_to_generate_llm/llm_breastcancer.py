...
df = pd.read_csv(
    "/home/ddp/nlp/github/paper/mypaper_code/automl/data/wisconsin_breast_cancer/wisconsin_breast_cancer_dataset.csv"
)
...
def local_dataset_inference(dataset_name):
    pass
